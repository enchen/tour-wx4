<template>
  <div class="dp-register-bg" >
   ...
   <div style="font-size: 30px;font-weight: 800">就差最后一步啦！</div>
    ...
    <div class="dp-phone">
      <div style="text-align: left">小组名称：</div>
      <div style="margin-top: 5px;"><input v-model="teamName"type="text" maxlength="11"
                                           class="dp-input"
                                           placeholder="请输入小组名称"></div>
    </div>
      ...
      methods:{
        checkValue(){
          ...
          submit()
          {
            ...
            {
              this.loading=true
              this.$http.post('/wx/public/teamLeaderRegister2.php',
                {
